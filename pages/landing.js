                ...
                <section id="one">
                    <div className="inner">
                        <header className="major">
                            <h2>Desenvolvimento de aplicatições || Websites Responsivos || Design Gráfico</h2>
                        </header>
                        <p>Partilhe sua visão connosco e deixe que a tornemos real.</p>
                    </div>
                </section>
